...
{	
	...
	{	
		...
		// Funcionários
		// Thayse, e o cálculo das competências dos funcionários?
		...
		E6 = new Employee(6, "Carla", "RH", false);
		p.addEmployee(E6);
		...
		// Calculando as Reservas de ContingÃªncia de Custo
